...
optimal_solution = data.frame(bonds$Maturity,bonds$Coupon,bonds$Asked,s$solution,s$duals[0:length(M)],
                              s$duals.to[0:length(M)],s$duals.from[0:length(M)])
names(optimal_solution) = c("Maturity","Coupon","Price","Amt. to Purchase","Duals","Duals From","Duals To")
optimal_solution
```
...
data.frame(bonds$Maturity,bonds$Coupon,bonds$Asked,s$solution,s$duals[0:length(M)],s$duals.to[0:length(M)],s$duals.from[0:length(M)])
