...
## 2nd: Using Correlation between Market Caps
```{r}
...
get weights and plot performance comparison
```{r}
...
legend(as.Date('2013-10-15'),1150000,c('NAS 100','INDEX'),lty=c(1,1),lwd=c(2,2),col=c('blue','red'))
```
We see that this index does track quite closely and consistently outperforms the NAS 100, this would be the best portfolio yet for something that tracks the NAS100 and still performs very well.
